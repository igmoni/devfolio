export const githubConfig = {
  ...
  errorState: {
    title: 'Unable to laod Github Contributions',
    desc: 'Checl out my profile directly for the latest activity',
    buttontext: 'View on Github'
  },

  loadingState: {
    title: 'Loading Github Contributions...',
    desc: 'Fetching the latest data from Github'
  }
}