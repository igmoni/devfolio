 ...
 const FreelanceText = () => {
    return (
        <div className="bg-green-400/40 dark:bg-green-500/10  border-green-300  flex w-[180px] relative text-[12px] items-center p-2 gap-2 text-white font-semibold rounded-[6px] px-3">
