...
const Quote = () => {
  ...
  return (
    <Container className={"px-5 py-16"}>
      <div className="realtive dark:border-dark-white-50 rounded-xl border px-16 py-10">
        <svg
          aria-hidden="true"
          width="105"
          height="78"
        ...
        <p className="dark:text-dark-white-300 z-10 font-mono font-medium text-pretty text-zinc-500 italic">
          {" "}
          “{quote}”
        </p>
